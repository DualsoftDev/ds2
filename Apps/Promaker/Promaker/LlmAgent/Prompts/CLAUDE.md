...
### 폴더 내 파일 안내
- `ai-yaml.md` — **promaker/v0 YAML 생성 주력 지침** (한국어 공정/PDF/PLC TAG → YAML, self-contained). 자동 주입.
- `0.domain.md` — DS 모델 도메인 배경 (`ai-yaml.md` 보조 — ArrowType 실행 의미 / 왕복=같은 Work / init call / 다중조건=AND 등). 자동 주입.
