...
- lib Tests: 100 → s6-r5 102 → s6-r8 109 → s6-r11 123 → s6-r12 128 → s6-r13 129 → s6-r14 131 → s6-r15 135 → s6-r16 136 (s6-r9/r10 회귀 0)
- **누적 485 Fact** (Promaker 208 + service 116 + IntegrationTests 25 + lib 136). s6-r16 = +1 Fact (Phase 2 task C4-Q2 OoxmlExtractor inline Drawing paragraph 매핑).
...
**다음 권장 (s6-r16 이후)** — Phase 2 잔여 진입 (D / E):
