[Code]
// Trimmed from https://github.com/DomGries/InnoDependencyInstaller
// Promaker only needs .NET 9 Desktop Runtime dependency
        ...
        while True do begin
          ...
          if ShellExec('', ExpandConstant('{tmp}{\}') + Dependency_List[DependencyIndex].Filename, Dependency_List[DependencyIndex].Parameters, '', SW_SHOWNORMAL, ewWaitUntilTerminated, ResultCode) then begin
            if Dependency_List[DependencyIndex].RestartAfter then begin
              ...
              break;
            end else if (ResultCode = 0) or Dependency_List[DependencyIndex].ForceSuccess then begin
              break;
            end else if ResultCode = 1641 then begin
              NeedsRestart := True;
              Result := Dependency_List[DependencyIndex].Title;
              break;
...
// .NET 9 Desktop Runtime (required for Promaker WPF)
