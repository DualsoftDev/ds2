...
public class OeeMathTests
{
    ...
    public void IsNonProductionByLength_flags_long_faults(double ctMs, double ctNp, bool expected)
        => Assert.Equal(expected, OeeMath.IsNonProductionByLength(ctMs, ctNp));
    ...
    public void ClassifyCycle_weekend_going_row_is_demoted_to_nonproduction_review()
    {
        ...
        Assert.Equal(OeeMath.CycleClass.NonProductionByLength, Cls(800_000, (int)CtNp, 20_000));   // 정확히 경계(≥) = 강등
    }
    ...
    public void ClassifyCycle_flow_without_mt_baseline_cannot_judge_fault()
    {
        ...
        Assert.Equal(OeeMath.CycleClass.NonProductionByLength, Cls(null, 5_100_000, null, mtF: 0, ctF: 0));
