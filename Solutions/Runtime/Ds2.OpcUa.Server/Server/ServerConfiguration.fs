    ...
    let build (cfg: DsServerConfig) : ApplicationConfiguration =
        ...
        let securityConfig =
            SecurityConfiguration(
                ...
                UserIssuerCertificates = CertificateTrustList(
                    StoreType = "Directory",
                    StorePath = Path.Combine(cfg.CertificateDir, "issuerUser")),
                TrustedUserCertificates = CertificateTrustList(
                    StoreType = "Directory",
                    StorePath = Path.Combine(cfg.CertificateDir, "trustedUser")),
