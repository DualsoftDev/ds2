...
> - 다음 리비전 trigger: WithCyl.json SSOT 영속화 결정 후 / §5.6 신규 6 tests 작성 진입 시점 / **C5 Active/Passive 단일 vs 분리 비교 결정 후** / rev 10 의 §1 op 수 감소 실측치 측정 후 / 후속 phase entity (IOTag / CallCondition / SubmodelProperty) 진입 시.
