...
module internal AasxConceptDescriptionCatalog =
    ...
    let extensionConceptDescriptionInfos: ConceptDescriptionInfo list = [
        ...
        { Id = MicrexSxInterfaceSemanticId
          PreferredNameDe = "MICREX-SX-Schnittstelle"
          PreferredNameEn = "MICREX-SX interface"
          PreferredNameKr = "MICREX-SX 인터페이스"
          ShortName = "InterfaceMicrexSx"
          DefinitionDe = "DualSoft-Erweiterung der AID für Fuji MICREX-SX Loader-Endpunkte."
          DefinitionEn = "DualSoft-managed AID extension for Fuji MICREX-SX loader endpoints."
          DefinitionKr = "Fuji MICREX-SX 로더 프로토콜 접속정보를 기술하는 DualSoft 관리형 AID 확장." }
