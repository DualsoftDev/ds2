...
let createTestStore() =
    ...
    robot1.SimulationProperties <- Some robot1Props
    ...
    conveyor1.SimulationProperties <- Some conveyor1Props
    ...
    cylinder1.SimulationProperties <- Some cylinder1Props
    ...
    unknown1.SimulationProperties <- Some unknown1Props
