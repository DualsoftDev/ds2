...
/// ***REDACTED***2 IO List signature 충족 xlsx (XlsxStrategiesTests.fs 의 makeIoListFixture 와 동형).
...
/// ***REDACTED***2 조립작업서 signature 충족 xlsx (XlsxStrategiesTests.fs 의 makeWorkOrderFixture 와 동형).
