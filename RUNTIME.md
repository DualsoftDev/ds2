...
Last Sync: 2026-03-22 (대규모 모듈 분할: Editor/SimIndex/Toolbar/MapperTargets/테스트 파일 분리)
...
TimeIgnore setter:
  prev=false → i=true 전환 + Running 상태:
    for wg in AllWorkGuids:
      Going + leaf (Call 없음) → ScheduleNow(DurationComplete wg)
